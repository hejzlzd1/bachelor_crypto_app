...
<div class="shadow p-4 mt-4 container">
    <h4 class="text-center">Porovnávací tabulka</h4>
    <table id="comparison" class="table table-dark table-striped table-bordered table-sm">
        <thead class="thead">
        <tr class="text-white">
            <th scope="col" class="th-sm">Název algoritmu</th>
            <th scope="col" class="th-sm">Malý soubor (0.5 MB) - v sekundách</th>
            <th scope="col" class="th-sm">Velký soubor (5 MB) - v sekundách</th>
        </tr>
        </thead>
        <tbody>
        <?php
