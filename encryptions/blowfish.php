...
<div class="container shadow p-4">
    <div class="section-title">
        <h4>Blowfish</h4>
        <p class="font-italic">
            Blowfish je symetrická bloková šifra využívaná ve spoustě šifrovacích produktech. Díky své proměnlivé délce
            klíče 32-448 bitů je tento algoritmus velice bezpečný. <br/>
            Jedná se o algoritmus vytvořený jakožto reakce na starý DES. Při svém šifrování využívá 64 bitových bloků a
            16 "kol" Feistelovy funkce. <br/>
            Jediná nevýhoda spočívá ve výhodě proměnného šifrovacího klíče - každá změna celý proces zpomaluje.
        </p>
    </div>
